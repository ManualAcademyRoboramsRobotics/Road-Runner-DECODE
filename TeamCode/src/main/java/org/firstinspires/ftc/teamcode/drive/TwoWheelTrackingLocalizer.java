...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public TwoWheelTrackingLocalizer(HardwareMap hardwareMap, SampleMecanumDrive drive) {
        ...
        parallelEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "ParaE"));
        perpendicularEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "PerpE"));
        ...
        //TODO: NEED TO CHECK TO SEE IF THIS IS NEEDED OR NOT!!!
    }
    ...
    public List<Double> getWheelVelocities() {
        ...
        return Arrays.asList(
                encoderTicksToInches(parallelEncoder.getCorrectedVelocity()), //Need to get corrected instead of raw due to encoder overflow of 16 bit ints
